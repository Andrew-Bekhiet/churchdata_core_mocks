...
class _FakeShareResult_0 extends _i1.Fake implements _i2.ShareResult {}
...
class MockSharePlatform extends _i1.Mock
  ...
  _i3.Future<void> shareFiles(List<String>? paths,
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<_i2.ShareResult> shareWithResult(String? text,
          {String? subject, _i4.Rect? sharePositionOrigin}) =>
      (super.noSuchMethod(
              Invocation.method(#shareWithResult, [
                text
              ], {
                #subject: subject,
                #sharePositionOrigin: sharePositionOrigin
              }),
              returnValue: Future<_i2.ShareResult>.value(_FakeShareResult_0()))
          as _i3.Future<_i2.ShareResult>);
  @override
  _i3.Future<_i2.ShareResult> shareFilesWithResult(List<String>? paths,
          {List<String>? mimeTypes,
          String? subject,
          String? text,
          _i4.Rect? sharePositionOrigin}) =>
      (super.noSuchMethod(
              Invocation.method(#shareFilesWithResult, [
                paths
              ], {
                #mimeTypes: mimeTypes,
                #subject: subject,
